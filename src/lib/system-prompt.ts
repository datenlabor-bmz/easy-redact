...
export function buildSystemPrompt(opts: {
  ...
  return [
    ...
    '4. **Gezielte Rückfragen**: Stelle NUR Fragen, die sich aus dem tatsächlichen Dokumentinhalt ergeben — zu Personen oder Fällen die wirklich unklar sind. Nicht abstrakt fragen, sondern konkret.',
    '5. **Vorschläge machen**: Nutze `suggest_redactions` mit konkreten Textfundstellen.',
    '',
    '## Standardmodus',
    '',
