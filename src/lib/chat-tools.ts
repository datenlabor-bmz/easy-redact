          ...
          suggestions: {
            ...
            items: {
              ...
              properties: {
                ...
                person: { type: 'string', description: 'Name of the person this redaction belongs to' },
                personGroup: { type: 'string', description: 'Group category, e.g. "Privatpersonen", "Bundesbeamte", "BMZ-Mitarbeiter"' },
                reason: { type: 'string', description: 'Brief explanation why this should be redacted' },
              },
              required: ['text', 'pageIndex', 'confidence'],
            },
          },
        },
