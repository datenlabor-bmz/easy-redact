...
export function PdfViewer({
  ...
  useEffect(() => {
    ...
    ;(async () => {
      ...
      for (const s of pendingSuggestions) if (!byText.has(s.text)) byText.set(s.text, s)
