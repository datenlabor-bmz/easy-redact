...
export function finalizeHighlight(page: PageData, highlight: HighlightInProgress): Redaction {
  if (highlight.type === 'freehand') {
    ...
    return {
      id: generateUUID(), pageIndex: highlight.pageIndex,
  ...
  return { id: generateUUID(), pageIndex: highlight.pageIndex, parts, status: 'manual', shouldApply: true, isAutoGenerated: false }
}
